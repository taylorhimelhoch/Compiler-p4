...
public:
	...
	virtual void attachSymbol(SemSymbol * symbolIn) { } 
	virtual std::string getName() = 0;
	SemSymbol * getSymbol() {return nullptr;}
	virtual bool nameAnalysis(SymbolTable * symTab) override;
};
...
public:
	...
	void attachSymbol(SemSymbol * symbolIn) override {mySymbol = symbolIn;}
...
public:
	...
	TypeNode * getTypeNode() const {return myRetType;}
	std::list<FormalDeclNode *> * getFormals() const{
		return myFormals;
	}
	std::list<StmtNode *> * getBody() const { return myBody;}
	void unparse(std::ostream& out, int indent) override;
	virtual bool nameAnalysis(SymbolTable * symTab) override;
private:
	TypeNode * myRetType;
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable * symTab) override;
	AssignExpNode * getExp() const {return myExp;}
private:
	AssignExpNode * myExp;
};
...
public:
	...
	virtual void unparse(std::ostream& out, int indent) override;
	std::string getName() {return myID->getName();}
	bool nameAnalysis(SymbolTable * symTab) override;
protected:
	IDNode * myID;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	std::string getType() override {return myBaseType->getType();}
private:
	TypeNode * myBaseType;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	std::string getType() override {return "short";}
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	LValNode * getDstNode() const {return myDst;}
	bool nameAnalysis(SymbolTable * symTab) override;
private:
	LValNode * myDst;
	ExpNode * mySrc;
